...
class FireShoot(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, facing_right, name=c.FIRESHOOT):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(100, 128, 23, 6))  # Frame 1 of flying
        self.frames.append(self.get_image(100, 128, 23, 6))  # Frame 2 of Flying
        self.frames.append(self.get_image(100, 128, 23, 6))  # Frame 3 of Flying
        self.frames.append(self.get_image(100, 128, 23, 6))  # Frame 4 of flying
        self.frames.append(self.get_image(112, 144, 16, 16))  # frame 1 of exploding
        self.frames.append(self.get_image(112, 160, 16, 16))  # frame 2 of exploding
        self.frames.append(self.get_image(112, 176, 16, 16))  # frame 3 of exploding
